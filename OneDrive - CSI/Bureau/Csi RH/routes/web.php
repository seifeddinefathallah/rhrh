...
//Route::resource('authorizations', AuthorizationRequestController::class);
Route::get('/authorizations/approved', [AuthorizationRequestController::class, 'approved'])->name('authorizations.approved');
...
Route::get('/leave-requests/generate-create-url', [LeaveRequestController::class, 'generateCreateRequestUrl'])
    ...
    Route::get('/events/generateCreateEventUrl', [EventController::class, 'generateCreateEventUrl'])->name('events.generateCreateEventUrl');


Route::get('/authorizations/generateAuthorizationUrl', [EventController::class, 'generateAuthorizationUrl'])
    ->name('authorizations.generateAuthorizationUrl');
