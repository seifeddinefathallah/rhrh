        ...
        <div class="layout-wrapper layout-content-navbar d-flex">
            ...
            <ul class="menu-inner py-1 d-flex" >
              ...
              <ul class="menu-sub">
                  ...
                  <li class="menu-item {{ request()->is('authorizations') ? 'active' : ''}}">
                    <a href="{{ route('authorizations.index') }}" class="menu-link" >
                      <div data-i18n="Error">Demande d'authorisation </div>
                    </a>
                  </li>
             ...
             <!-- </li>
              ...
              <li class="menu-item {{ request()->is('leave_types')  || request()->is('leave_types/create') || request()->is('temporary-balances/update') ? 'active' : ''}}">
                <a href="#" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons bx bx-menu"></i>
                    <div data-i18n="Boxicons" style="display: block; ">Paramétrage</div>
                </a>
                <ul class="menu-sub">
                    <li class="menu-item {{ request()->is('leave_types') ? 'active' : ''}}">
                        <a href="#" class="menu-link menu-toggle">
                          
                            <div data-i18n="Error" style="display: block; text-align: center;">Type des congés</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item {{ request()->is('leave_types') ? 'active' : '' }}">
                                <a href="{{ route('leave_types.index') }}" class="menu-link">
                                    <div data-i18n="Connections">Liste des types de congés</div>
                                </a>
                            </li>
                            <li class="menu-item {{ request()->is('leave_types/create') ? 'active' : '' }}">
                                <a href="{{ route('leave_types.create') }}" class="menu-link">
                                    <div data-i18n="Connections">Créer type de congé</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu-item {{ request()->is('temporary-balances/update') ? 'active' : ''}}">
                        <a href="{{ route('authorizations.update-temporary-balances') }}" class="menu-link">
                            <div data-i18n="Error">Personnaliser Autorisation</div>
                        </a>
                    </li>
                ...
                <li class="menu-item {{ request()->is('events') ? 'active' : ''}}">
                  <a href="{{ route('events.index') }}" class="menu-link">
                      ...
                      <div data-i18n="Basic">Evenements
                      </div>
                  </a>
              </li>
            </li>
