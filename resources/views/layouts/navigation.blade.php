        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('entites.index')" :active="request()->routeIs('entites.index')">
                        {{ __('Entites') }}
                    </x-nav-link>
                    <x-nav-link :href="route('departements.index')" :active="request()->routeIs('departements.index')">
                        {{ __('Departements') }}
                    </x-nav-link>
                    <x-nav-link :href="route('postes.index')" :active="request()->routeIs('postes.index')">
                        {{ __('Postes') }}
                    </x-nav-link>
                    <x-nav-link :href="route('authorizations.index')" :active="request()->routeIs('authorizations.index')">
                        {{ __('Authorizations') }}
                    </x-nav-link>
 		            <x-nav-link :href="route('contracts.index')" :active="request()->routeIs('contracts.index')">
                        Contrats
                    </x-nav-link>
                    <x-nav-link :href="route('loan_requests.index')" :active="request()->routeIs('loan_requests.index')">
                        {{ __('Demandes Prêts et avances') }}
                    </x-nav-link>
                </div>
            </div>
