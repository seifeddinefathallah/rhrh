            ...
            <table class="table table-striped">
                ...
                @forelse($requests as $request)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('material_requests.show', $request->id) }}" class="btn btn-outline-primary btn-sm">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('material_requests.edit', $request->id) }}" class="btn btn-outline-success btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('material_requests.destroy', $request->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                            ...
                            <form action="{{ route('material_requests.approve', $request->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('PUT')
                            ...
                            <form action="{{ route('material_requests.reject', $request->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('PUT')
