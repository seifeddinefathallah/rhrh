                    ...
                    <div class="border mb-4 p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="passeport_numero" id="passeport_numero" class="form-input mt-1 block w-full" value="{{ old('passeport_numero') }}">
                            </div>

                            <div class="mb-4">
                                <label for="passeport_date_delivrance" class="block text-sm font-medium text-gray-700">Passeport Date Délivrance</label>
                                <input type="date" name="passeport_date_delivrance" id="passeport_date_delivrance" class="form-input mt-1 block w-full" value="{{ old('passeport_date_delivrance') }}">
                            </div>

                            <div class="mb-4">
                                <label for="passeport_date_expiration" class="block text-sm font-medium text-gray-700">Passeport Date Expiration</label>
                                <input type="date" name="passeport_date_expiration" id="passeport_date_expiration" class="form-input mt-1 block w-full" value="{{ old('passeport_date_expiration') }}">
                            </div>

                            <div class="mb-4">
                                <label for="passeport_delai_validite" class="form-label">Passport Délai de Validité (jours)</label>
                                <input type="number"  id="passeport_delai_validite" name="passeport_delai_validite" class="form-input mt-1 block w-full" value="{{ old('passeport_delai_validite') }}" readonly>
                            </div>
                    ...
                    <div class="border mb-4 p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <input type="text" name="carte_sejour_numero" id="carte_sejour_numero" class="form-input mt-1 block w-full" value="{{ old('carte_sejour_numero') }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="carte_sejour_date_delivrance" id="carte_sejour_date_delivrance" class="form-input mt-1 block w-full" value="{{ old('carte_sejour_date_delivrance') }}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="date" name="carte_sejour_date_expiration" id="carte_sejour_date_expiration" class="form-input mt-1 block w-full" value="{{ old('carte_sejour_date_expiration') }}">
                            </div>

                            <div class="mb-4">
                                <label for="carte_sejour_type" class="block text-sm font-medium text-gray-700">Carte de Séjour Type</label>
                                <input type="text" name="carte_sejour_type" id="carte_sejour_type" class="form-input mt-1 block w-full" value="{{ old('carte_sejour_type') }}">
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            selectSituationFamiliale.addEventListener('change', function () {
                if (selectSituationFamiliale.value === 'Autre') {
                    ...
                    autreSituationFamilialeInput.setAttribute('required', 'required'); // Ajouter l'attribut required si nécessaire
                } else {
                    autreSituationFamilialeDiv.style.display = 'none';
                    autreSituationFamilialeInput.removeAttribute('required'); // Supprimer l'attribut required si nécessaire
                }
            });
