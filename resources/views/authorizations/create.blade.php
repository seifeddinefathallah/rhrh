                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('authorizations.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="start_time" id="start_time" class="form-input mt-1 block w-full">
                            @error('start_time')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="end_time" id="end_time" class="form-input mt-1 block w-full">
                            @error('end_time')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="duration_type" id="duration_type" class="form-input mt-1 block w-full" readonly>
                            @error('duration_type')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="duration" id="duration" class="form-input mt-1 block w-full" readonly>
                            @error('duration')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
