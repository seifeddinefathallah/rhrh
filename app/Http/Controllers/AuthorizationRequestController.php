...
class AuthorizationRequestController extends Controller
{
   ...
   /* protected function updateEmployeeBalance($employeeId, $authorization)
    ...
    public function updateTemporaryBalances(Request $request)
    {
        ...
        // Update or create the temporary balance record for each employee
        foreach ($employees as $employee) {
            TemporaryBalance::updateOrCreate(
                [
        ...
        return redirect()->route('authorizations.index')->with('success', 'Temporary balances updated successfully for all employees.');
       //return redirect()->back()->with('success', 'Temporary balances updated successfully for all employees.');
    }
